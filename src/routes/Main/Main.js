...
class Main extends Component {
  ...
  render() {
    if (
      ...
      // return <div>{this.spiner()}</div>;
      return (
        <div style={{ textAlign: 'center' }}>
          <img src="https://mmrq.s3.ap-northeast-2.amazonaws.com/lg.puppy-dog-ajax-spinner.gif" />
          {/* <img src="http://blog.hivelab.co.kr/wp-content/uploads/2017/10/004.gif" /> */}
        </div>
      )
    ...
    return (
      <div>
        <div className="component_body">
          ...
          />
          <MainSection3
            witnessData={this.state.witnessData}
