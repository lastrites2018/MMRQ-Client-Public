  ...
  render() {
    ...
    return (
      <div>
        ...
        <p className="pet_name"><a>{this.props.findData[0].petname}</a> 찾아주세요!!</p>
        <p className="pet_breed">{`${this.props.findData[0].petbreed} / ${this.props.findData[0].petsex}`}</p>
        <p className="pet_lost_location"><a style={{borderBottom:"2px solid"}}>{this.props.findData[0].location}</a></p>
        <p className="pet_post_contents">{this.props.findData[0].contents}</p>
        </div>
        </div>
