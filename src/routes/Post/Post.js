...
class Post extends Component {
  ...
  changeCurrentClassification = event => {
    this.setState({ currentClassification: event.target.value });
    console.log("currentttt", this.state.currentClassification);
  };
    ...
    return (
      <div className="post_body">
        <div className="classificationButton">
          <Form
            id="text-form"
            onChange={formState => console.log(formState.values)}
          >
            <Select field="status" id="select-status">
              <Option value="" disabled>
                Select One...
              </Option>
              <Option value="searching">찾아주세요</Option>
              <Option value="witness">목격했어요</Option>
            </Select>
          </Form>
          {/* <select
            className="classification"
            value={this.state.currentClassification}
            onChange={this.changeCurrentClassification}
          >
            <option value="searching">찾아주세요</option>
            <option value="witness">목격했어요</option>
          </select> */}
        ...
        <div className="location">
          <select className="city">
            {this.state.city.map((city, index) => {
              // city 선택에 따라 district 따라 변화하는 방법 찾아보기
              return (
